		...
		<div class="row ipad-width2">
			<div class="col-md-8 col-sm-12 col-xs-12">
				<div class="topbar-filter">
					...
					<a href="movielist.blade.php" class="list"><i class="ion-ios-list-outline active"></i></a>
					<a href="moviegrid.blade.php" class="grid"><i class="ion-grid"></i></a>
				</div>
				<div class="movie-item-style-2">
					<img src="images/uploads/mv1.jpg" alt="">
					<div class="mv-item-infor">
						<h6><a href="moviesingle.blade.php">oblivion <span>(2012)</span></a></h6>
				...
				<div class="movie-item-style-2">
					...
					<div class="mv-item-infor">
						<h6><a href="moviesingle.blade.php">into the wild <span>(2014)</span></a></h6>
				...
				<div class="movie-item-style-2">
					...
					<div class="mv-item-infor">
						<h6><a href="moviesingle.blade.php">blade runner  <span>(2015)</span></a></h6>
				...
				<div class="movie-item-style-2">
					...
					<div class="mv-item-infor">
						<h6><a href="moviesingle.blade.php">Mulholland pride<span> (2013)  </span></a></h6>
				...
				<div class="movie-item-style-2">
					...
					<div class="mv-item-infor">
						<h6><a href="moviesingle.blade.php">skyfall: evil of boss<span> (2013)  </span></a></h6>
